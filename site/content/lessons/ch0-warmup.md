...
rectangle "01\n導言\n理解原理" as step1 #F7B7B7
rectangle "02\nCh0\n暖身" as step2 #FBD2A6
rectangle "03\nCh1\nVibe Coding MVP" as step3 #CFE9B5
rectangle "04\nCh2\n從 MVP 到規格\nProposal = MVP 結晶" as step4 #C7E5F4
rectangle "05\nCh3\nTechnical Spec\nOpenSpec 工作流" as step5 #BFD6F2
rectangle "06\nCh4\nCoding Agent\n依 tasks.md 實作" as step6 #B6C7EE
rectangle "07\nCh5\n驗證、測試、可觀測性\nopenspec verify + archive" as step7 #AEB9E8
rectangle "08\nCh6\n團隊協作與規模化" as step8 #A5ACE1
...
footer 附錄：工具安裝（OpenSpec CLI、OpenCode、Ollama）
@enduml
```
